...
const MethodChannel _channel =
    MethodChannel("pro.lichuang.blindenglish/player");
...
class PlayerController extends ValueNotifier<PlayerControllerState> {
  ...
  Future<void> playWith(Music music) {
    assert(music != null);
    return _channel.invokeMethod("playWithMusic", music.toMap());
  }
  ...
  Future<void> rewind() async {
    ...
    LyricContent lyric = value.current.lyric;
    int currentTime = value.position.inMilliseconds;
    int seekTo = currentTime - 10000;
    if (lyric != null) {
      int currentLine = lyric.findLineByTimeStamp(currentTime, 0);
