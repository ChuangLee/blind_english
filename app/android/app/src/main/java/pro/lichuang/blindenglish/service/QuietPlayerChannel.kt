package pro.lichuang.blindenglish.service
...
import pro.lichuang.blindenglish.player.Music
import pro.lichuang.blindenglish.player.MusicPlayerCallback
import pro.lichuang.blindenglish.player.PlayMode
...
class QuietPlayerChannel(private val channel: MethodChannel) : MethodChannel.MethodCallHandler {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "pro.lichuang.blindenglish/player"
    ...
    fun rewind() {
        channel.invokeMethod("onRewind", null)
    }
