...
import pro.lichuang.blindenglish.AppContext
import pro.lichuang.blindenglish.player.playlist.Playlist
import pro.lichuang.blindenglish.player.service.QuietPlayerService.Companion.ensureServiceRunning
import pro.lichuang.blindenglish.utils.LoggerLevel
import pro.lichuang.blindenglish.utils.log
import java.util.*
...
class QuietMusicPlayer {
    ...
    private val player by lazy {
        log(LoggerLevel.ERROR) { "val player by lazy===" }
    ...
    private val musicPlayerCallback = object : MusicPlayerCallback {
        ...
        override fun onPlaylistUpdated(playlist: Playlist) = callbacks.forEach {
            log(LoggerLevel.ERROR) { "onPlaylistUpdated===" }
